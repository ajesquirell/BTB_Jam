...
{
public:
	cTile(std::string tileName, float x, float y, bool solid);
...
public:
	...
	virtual void Update(float fElapsedTime, cDynamic* player = nullptr) { animTile.Update(fElapsedTime); };
...
{
public:
	cTile_Color(float x, float y, olc::Pixel color);
...
{
public:
	cTile_Invisible_Boundary(float x, float y);
};

//==================================================================================================================================================================================================
//																					GATE BLOCK - When player moves past block, becomes solid
//==================================================================================================================================================================================================
class cTile_Gate : public cTile
{
public:
	cTile_Gate(float x, float y);
	void Update(float fElapsedTime, cDynamic* player = nullptr) override;
};