...
private:
	...
	cTile_Invisible_Boundary* staticBoundary = new cTile_Invisible_Boundary(0, 0); //Need to return this to prevent memory leak if accessing out of bounds, b/c before
